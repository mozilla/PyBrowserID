...
from browserid.tests.support import get_keypair, unittest, to_int
from browserid.utils import encode_json_bytes, encode_bytes, long_to_bytes
...
RS64_KEY_DATA = {
    "e": encode_bytes(long_to_bytes(to_int("65537"))),
    "n": encode_bytes(long_to_bytes(to_int("""
                110897663942528265066856163966583557538666146275146
    ...
    "d": encode_bytes(long_to_bytes(to_int("""
                295278123166626215026113502482091502365034141401240
...
RS128_KEY_DATA = {
    "e": encode_bytes(long_to_bytes(to_int("65537"))),
    "n": encode_bytes(long_to_bytes(to_int("""
                160958612207243135258426337209518369415128632560962
                ...
                38123335501"""))),
    "d": encode_bytes(long_to_bytes(to_int("""
                585460335046807430656021335489952071366989081433116
...
RS256_KEY_DATA = {
    "e": encode_bytes(long_to_bytes(to_int("65537"))),
    "n": encode_bytes(long_to_bytes(to_int("""
                215157110954304992279368637802866269325596452629865
    ...
    "d": encode_bytes(long_to_bytes(to_int("""
                207323904265915659359360496298103480082712690236486
...
DS128_KEY_DATA = {
    "p": encode_bytes(long_to_bytes(to_int(
                """6703904104057623261995085583676902361410672713749348
                7374515589871295072792250899011720632358392764362903244
                12395020783955234715731001076129344181463063193"""))),
    "q": encode_bytes(long_to_bytes(to_int("""
                1006478751418673383937866166434285354892250535133"""))),
    "g": encode_bytes(long_to_bytes(to_int("""
                1801778249650423365253284139284406405780267098493217
                0320675876307450879812560049234773036938891018778074993
                01874343843218156663689824126183823813389886834"""))),
    "y": encode_bytes(long_to_bytes(to_int("""
                4148629652526876030475847300836791685289385792662680
                5886292874741635965095055693693232436255359496594291250
                77637642734034732001089176915352691113947372211"""))),
    "x": encode_bytes(long_to_bytes(to_int("""
                487025797851506801093339352420308364866214860934"""))),
}


DS256_KEY_DATA = {
    "p": encode_bytes(long_to_bytes(to_int("""
                2711208960741861745308573380095332404137549620315947
                ...
                575145555997697"""))),
    "q": encode_bytes(long_to_bytes(to_int("""
                8046122811817605537462867507324490518169978963150408
                3583246408785452219083579"""))),
    "g": encode_bytes(long_to_bytes(to_int("""
                1950500789762808721425847074198373330399312960690977
                ...
                472198869382895"""))),
    "y": encode_bytes(long_to_bytes(to_int("""
                1844313351983285974903941411114978471875302034844347
                ...
                554039792987016"""))),
    "x": encode_bytes(long_to_bytes(to_int("""
                516894755741455110020515548698805157573799751826"""))),
}
